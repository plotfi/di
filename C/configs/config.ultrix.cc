...
#define _memberxdr_rquota_rq_bsoftlimit 1
#define xdr_rq_curblocks xdr_u_long
#define _memberxdr_rquota_rq_curblocks 1
#define xdr_rq_fhardlimit xdr_u_long
#define _memberxdr_rquota_rq_fhardlimit 1
#define xdr_rq_fsoftlimit xdr_u_long
...
#define _quotactl_pos_2 0
#define _args_setmntent 0
#define _args_statfs 2
#define _c_arg_1_statfs char *
#define _c_arg_2_statfs struct fs_data
...
#define _mem_struct_getquota_rslt_gqr_status 1
#define _mem_struct_getquota_rslt_gqr_rquota 1
