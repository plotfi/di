...
#define _mem_dqb_curblocks_dqblk 0
#define _mem_dqb_fhardlimit_dqblk 0
#define _mem_dqb_fsoftlimit_dqblk 0
#define _mem_dqb_curfiles_dqblk 0
#define _mem_gqr_status_getquota_rslt 0
#define _mem_gqr_rquota_getquota_rslt 0
#define _mem_f_bsize_statfs 0
